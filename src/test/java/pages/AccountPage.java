...
public class AccountPage extends BasePage{
    ...
    private static final By CONFIRM_NOTIFICATION =
            By.xpath("//td[@class = 'dialogMiddleCenter']//div[@class = 'gwt-Label']");
    ...
    public void createSettings(Account account){
        ...
        new Input(driver, "Отчество").clearAndWrite(account.getSname());
        new Input(driver, "Фамилия").clearAndWrite(account.getLname());
        new Input(driver, "Телефон").clearAndWrite(account.getPhone());
        new Input(driver, "Должность").clearAndWrite(account.getDolzn());
